...
from exercicios.pratica_4 import Livro
...
print(
    f"Antes de emprestar (biblioteca): Livro disponível? {livro_biblioteca.disponivel}"
)
Livro.livros.append(livro_biblioteca)

livro_biblioteca.emprestar()
print(
    f"Depois de emprestar (biblioteca): Livro disponível? {livro_biblioteca.disponivel}"
)
